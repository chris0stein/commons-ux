...
jq(document).ready( function() {
	...
	jq("input#aw-whats-new-submit").click( function() {
		...
		var firstrow = jq( '#content ul.activity-list li' ).first();
	...
	jq( '.dir-search, .groups-members-search' ).click( function(event) {
	...
	jq("#cacap-edit-form input:not(:submit), #cacap-edit-form textarea, #cacap-edit-form select, #signup_form input:not(:submit), #signup_form textarea, #signup_form select").change( function() {
		var shouldconfirm = true;

		var cancel_link = jq('.cacap-edit-cancel');
		var cancel_link_target = cancel_link.attr("href");
		if ( shouldconfirm && typeof dialog_element === 'undefined' ) {
			dialog_element = jq("<p id='dialog-confirm'>You have unsaved changes to your profile. Are you sure you want to leave this page? Click 'OK' to leave the page, or 'Back' to go back to editing.</p>").insertAfter(cancel_link);
		...
		jq('#cacap-edit-form input:submit, #signup_form input:submit').on( 'click', function() {
			shouldconfirm = false;
		});
		...
		cancel_link.on('click', function(event) {
			if ( shouldconfirm ) {
				event.preventDefault();
				var dialog_element = jq("#dialog-confirm");
				dialog_element.dialog("option", "buttons", {
					"Ok": function( event ) { shouldconfirm = false; window.location.href= cancel_link_target },
					"Back": function ( event) { jq(this).dialog("close"); }
 				});
	...
	jq('#members-dir-list, #members-grou-list').on('click', '.friendship-button a', function() {
